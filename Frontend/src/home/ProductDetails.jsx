...
// Later move this data to assets.js
// =====================================================
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-14">
          ...
          >
            ...
            <div className="mt-2 text-sm text-gray-500">
              {quantity} × Rs. {product.price.toLocaleString()}
              {" = "}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-8">
              ...
              <div className="border rounded-xl p-4 text-center">
                ...
                <p className="mt-2 text-sm font-medium">Gift Packaging</p>
              </div>

              <div className="border rounded-xl p-4 text-center">
                <FaShieldAlt className="mx-auto text-pink-600 text-xl" />

                <p className="mt-2 text-sm font-medium">Secure Order</p>
              </div>
            </div>
          </motion.div>
        </div>
